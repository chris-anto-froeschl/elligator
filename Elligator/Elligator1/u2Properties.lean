...
lemma u2_eq_u
  ...
  u2_of_t = u_of_t := by
    ...
    have h1 : (c_of_s - 1) * s * X2_of_t * (1 + X2_of_t) = x_of_t * Y_of_t := by
      unfold X2_of_t
      rw [X_h]
      rw [← div_left_inj' (Y_ne_zero s_h1 field_cardinality q_prime_power q_mod_4_congruent_3 t)]
      change x_of_t = x_of_t * Y_of_t / Y_of_t
      rw [mul_div_assoc, div_self (Y_ne_zero s_h1 field_cardinality q_prime_power q_mod_4_congruent_3 t)]
      ring_nf
    have h2 : z_of_point = χ_of_Y * (LegendreSymbol.χ (X_of_t^2 + 1 / c_of_s^2)) := by
      calc
        ...
        _ = χ_of_Y * (LegendreSymbol.χ (X_of_t^2 + 1 / c_of_s^2)) := by
          ...
          rw [LegendreSymbol.χ_of_a_mul_b_eq_χ_of_a_mul_χ_of_b]
          rw [LegendreSymbol.χ_a_eq_one (FiniteFieldBasic.pow_two_ne_zero (x_ne_zero s_h1 s_h2 field_cardinality q_prime_power q_mod_4_congruent_3 t)) (IsSquare.sq x_of_t) field_cardinality q_mod_4_congruent_3]
          unfold χ_of_Y
          ring_nf
    have h3 : (LegendreSymbol.χ (u_of_t^2 + 1 / c_of_s^2)) = (LegendreSymbol.χ (X_of_t^2 + 1 / c_of_s^2)) := by
      ...
      nth_rw 3 [pow_two]
      rw [← LegendreSymbol.χ_of_a_mul_b_eq_χ_of_a_mul_χ_of_b]
      rw [← pow_two, LegendreSymbol.χ_a_eq_one (FiniteFieldBasic.pow_two_ne_zero (v_ne_zero s_h1 field_cardinality q_prime_power q_mod_4_congruent_3 t)) (IsSquare.sq v_of_t) field_cardinality q_mod_4_congruent_3]
      unfold u_of_t
      simp_all
    have h4 : χ_of_Y = χ_of_v * (LegendreSymbol.χ (X_of_t^2 + 1 / c_of_s^2)) := by
      ...
      rw [LegendreSymbol.χ_a_eq_one (χ_of_v_mul_v_of_t_pow_q_add_one_over_four_ne_zero t s_h1 field_cardinality q_prime_power q_mod_4_congruent_3) (χ_IsSquare_h1 t s_h1 field_cardinality q_prime_power q_mod_4_congruent_3) field_cardinality q_mod_4_congruent_3]
      rw [LegendreSymbol.χ_of_a_mul_b_eq_χ_of_a_mul_χ_of_b]
    ...
    have h5 : z_of_point = χ_of_v := by
      ...
      rw [LegendreSymbol.χ_a_eq_one (FiniteFieldBasic.pow_two_ne_zero (X_pow_two_add_one_over_c_pow_two_ne_zero s_h1 field_cardinality q_prime_power q_mod_4_congruent_3 t)) (IsSquare.sq (X_of_t^2 + 1 / c_of_s^2)) field_cardinality q_mod_4_congruent_3]
      simp
    rw [h5]
    unfold X_of_t X
...
lemma u2_eq_u'
  ...
  u2_of_t = u'_of_t := by
    ...
    let χ_of_v := LegendreSymbol.χ v_of_t
    let χ_of_v' := LegendreSymbol.χ v'_of_t
    let χ_of_Y := LegendreSymbol.χ Y_of_t
    let χ_of_Y' := LegendreSymbol.χ Y'_of_t
    unfold u2_of_t u2
    rw [X_h]
    ...
    have h1 : (c_of_s - 1) * s * X2_of_t * (1 + X2_of_t) = x'_of_t * Y'_of_t := by
      unfold X2_of_t
      rw [X_h]
      rw [← div_left_inj' (Y_ne_zero s_h1 field_cardinality q_prime_power q_mod_4_congruent_3 ⟨-t.val, h2_2⟩)]
      change x'_of_t = x'_of_t * Y'_of_t / Y'_of_t
      rw [mul_div_assoc, div_self (Y_ne_zero s_h1 field_cardinality q_prime_power q_mod_4_congruent_3 ⟨-t.val, h2_2⟩)]
      ring_nf
    have h2 : z_of_point = χ_of_Y' * (LegendreSymbol.χ (X'_of_t^2 + 1 / c_of_s^2)) := by
      calc
        z_of_point = (LegendreSymbol.χ (x'_of_t^2 * Y'_of_t * (X'_of_t^2 + 1 / c_of_s^2))) := by
          ...
          rw [x_comparison t s_h1 field_cardinality q_prime_power q_mod_4_congruent_3]
          rw [X_h]
          ring_nf
        _ = χ_of_Y' * (LegendreSymbol.χ (X'_of_t^2 + 1 / c_of_s^2)) := by
          rw [LegendreSymbol.χ_of_a_mul_b_eq_χ_of_a_mul_χ_of_b]
          rw [LegendreSymbol.χ_of_a_mul_b_eq_χ_of_a_mul_χ_of_b]
          rw [LegendreSymbol.χ_a_eq_one (FiniteFieldBasic.pow_two_ne_zero (x_ne_zero s_h1 s_h2 field_cardinality q_prime_power q_mod_4_congruent_3 ⟨-t, h2_2⟩)) (IsSquare.sq x'_of_t) field_cardinality q_mod_4_congruent_3]
          unfold χ_of_Y'
          ring_nf
    have h3 : (LegendreSymbol.χ (u'_of_t^2 + 1 / c_of_s^2)) = (LegendreSymbol.χ (X'_of_t^2 + 1 / c_of_s^2)) := by
      ...
      nth_rw 3 [pow_two]
      rw [← LegendreSymbol.χ_of_a_mul_b_eq_χ_of_a_mul_χ_of_b]
      rw [← pow_two, LegendreSymbol.χ_a_eq_one (FiniteFieldBasic.pow_two_ne_zero (v_ne_zero s_h1 field_cardinality q_prime_power q_mod_4_congruent_3 ⟨-t, h2_2⟩)) (IsSquare.sq v'_of_t) field_cardinality q_mod_4_congruent_3]
      unfold u'_of_t
      simp_all
    have h4 : χ_of_Y' = χ_of_v' * (LegendreSymbol.χ (X'_of_t^2 + 1 / c_of_s^2)) := by
      ...
      rw [mul_assoc, LegendreSymbol.χ_of_a_mul_b_eq_χ_of_a_mul_χ_of_b]
      rw [LegendreSymbol.χ_a_eq_one (χ_of_v_mul_v_of_t_pow_q_add_one_over_four_ne_zero ⟨-t.val, h2_2⟩ s_h1 field_cardinality q_prime_power q_mod_4_congruent_3) (χ_IsSquare_h1 ⟨-t.val, h2_2⟩ s_h1 field_cardinality q_prime_power q_mod_4_congruent_3) field_cardinality q_mod_4_congruent_3]
      rw [LegendreSymbol.χ_of_a_mul_b_eq_χ_of_a_mul_χ_of_b]
      rw [LegendreSymbol.χ_of_χ_of_a_eq_χ_of_a field_cardinality q_prime_power q_mod_4_congruent_3]
      rw [LegendreSymbol.χ_of_χ_of_a_eq_χ_of_a field_cardinality q_prime_power q_mod_4_congruent_3]
      unfold χ_of_v' χ_sum
    ...
    have h5 : z_of_point = χ_of_v' := by
      rw [h2, h4, mul_assoc]
      rw [← LegendreSymbol.χ_of_a_mul_b_eq_χ_of_a_mul_χ_of_b, ← pow_two]
      rw [LegendreSymbol.χ_a_eq_one (FiniteFieldBasic.pow_two_ne_zero (X_pow_two_add_one_over_c_pow_two_ne_zero s_h1 field_cardinality q_prime_power q_mod_4_congruent_3 ⟨-t.val, h2_2⟩)) (IsSquare.sq (X'_of_t^2 + 1 / c_of_s^2)) field_cardinality q_mod_4_congruent_3]
      simp
    rw [h5]
    unfold X'_of_t X
...
lemma u2_h1
  ...
  u2_of_t = u_of_t ∨ u2_of_t = u'_of_t := by
    ...
    rcases (X2_h4 t s_h1 s_h2 field_cardinality q_prime_power q_mod_4_congruent_3) with h | h
    · left
      exact u2_eq_u t s_h1 s_h2 field_cardinality q_prime_power q_mod_4_congruent_3 h
    · right
      exact u2_eq_u' t s_h1 s_h2 field_cardinality q_prime_power q_mod_4_congruent_3 h
...
lemma one_add_u2_ne_zero_main_case
  ...
  1 + u2 ≠ 0 := by
    intro P u2
    unfold u2
    obtain h|h := u2_h1 t s_h1 s_h2 field_cardinality q_prime_power q_mod_4_congruent_3
    · rw [h]
...
lemma u'_pow_two_eq_X_pow_two
  ...
  u^2 = X^2 := by
    intro u X
    let z'_eq_one_or_z'_eq_neg_one := z'_eq_one_or_z'_eq_neg_one s_h1 s_h2 field_cardinality q_prime_power q_mod_4_congruent_3 point point_props x_ne_zero y_ne_one
    let z :=z' s_h2 field_cardinality q_prime_power q_mod_4_congruent_3 point
    unfold u u'
    grind
...
lemma u'_ne_neg_one
  ...
  X ≠ 1 → u ≠ -1 := by
    ...
    let z'_eq_one_or_z'_eq_neg_one := z'_eq_one_or_z'_eq_neg_one s_h1 s_h2 field_cardinality q_prime_power q_mod_4_congruent_3 point point_props x_ne_zero y_ne_one
    let z :=z' s_h2 field_cardinality q_prime_power q_mod_4_congruent_3 point
    let X2_ne_one_and_X2_ne_neg_one_of_X2_ne_one := X2_ne_one_and_X2_ne_neg_one_of_X2_ne_one s_h1 field_cardinality q_prime_power q_mod_4_congruent_3 ⟨point.val, point_props⟩ y_ne_one
    unfold u u'
    grind
...
lemma v'_eq_z'_mul_Y'_pow_two
  ...
  let v := v' s_h2 field_cardinality q_prime_power q_mod_4_congruent_3 point
  let X := X2 s point q
  X ≠ 1 → v = z * Y^2 := by
    intro z Y v X h1
    let r := r s
    let c := c s
    let X2_ne_one_and_X2_ne_neg_one_of_X2_ne_one := X2_ne_one_and_X2_ne_neg_one_of_X2_ne_one s_h1 field_cardinality q_prime_power q_mod_4_congruent_3 ⟨point.val, point_props⟩ y_ne_one
    let Y'_pow_two_eq_of_X2_ne_one := Y'_pow_two_eq_of_X2_ne_one s_h1 s_h2 field_cardinality q_prime_power q_mod_4_congruent_3 point point_props y_ne_one
    let z_pow_three_eq_z := LegendreSymbol.χ_of_a_pow_n_eq_χ_a (Y * (X^2 + 1 / c^2)) ⟨3, by grind⟩ field_cardinality q_prime_power q_mod_4_congruent_3
    change z^3 = z at z_pow_three_eq_z
    let z_pow_five_eq_z := LegendreSymbol.χ_of_a_pow_n_eq_χ_a (Y * (X^2 + 1 / c^2)) ⟨5, by grind⟩ field_cardinality q_prime_power q_mod_4_congruent_3
...
lemma v'_ne_zero
  ...
  X ≠ 1 → v ≠ 0 := by
    intro X v h1
    let v'_eq_z'_mul_Y'_pow_two := v'_eq_z'_mul_Y'_pow_two s_h1 s_h2 field_cardinality q_prime_power q_mod_4_congruent_3 point point_props y_ne_one
    let z :=z' s_h2 field_cardinality q_prime_power q_mod_4_congruent_3 point
    let Y := Y' s_h2 field_cardinality q_prime_power q_mod_4_congruent_3 point
    have h2 : v = z * Y^2 := by grind
    rw [h2]
    let h3 := Y'_ne_zero s_h1 s_h2 field_cardinality q_prime_power q_mod_4_congruent_3 point point_props x_ne_zero y_ne_one
    let z_ne_zero := z'_ne_zero s_h1 s_h2 field_cardinality q_prime_power q_mod_4_congruent_3 point point_props x_ne_zero y_ne_one
    grind
...
lemma χ_of_v'_eq_χ_of_z'
  ...
  X ≠ 1 → χ_of_v = χ_of_z := by
    ...
    let h2 := Y'_ne_zero s_h1 s_h2 field_cardinality q_prime_power q_mod_4_congruent_3 point point_props x_ne_zero y_ne_one
...
lemma χ_of_v'_eq_z'
  ...
  X ≠ 1 → χ_of_v = z := by
    ...
    let χ_of_v'_eq_χ_of_z' := χ_of_v'_eq_χ_of_z' s_h1 s_h2 field_cardinality q_prime_power q_mod_4_congruent_3 point point_props x_ne_zero y_ne_one
...
lemma X'_eq_χ_of_v'_mul_u'
  ...
  X ≠ 1 → X = χ_of_v * u := by
    ...
    let χ_of_v'_eq_z' := χ_of_v'_eq_z' s_h1 s_h2 field_cardinality q_prime_power q_mod_4_congruent_3 point point_props x_ne_zero y_ne_one
    unfold χ_of_v v
    rw [χ_of_v'_eq_z' h1]
    let z :=z' s_h2 field_cardinality q_prime_power q_mod_4_congruent_3 point
    let z_ne_zero := z'_ne_zero s_h1 s_h2 field_cardinality q_prime_power q_mod_4_congruent_3 point point_props x_ne_zero y_ne_one
...
lemma χ_of_v'_eq_χ_Y'_mul_u'_pow_two_add_one_over_c_pow_two
  ...
  X ≠ 1 → χ_of_v = χ_of_term := by
    ...
    let χ_of_v'_eq_z'_unfold_of_X'_ne_1 := χ_of_v'_eq_z'_unfold_of_X'_ne_1 s_h1 s_h2 field_cardinality q_prime_power q_mod_4_congruent_3 point point_props x_ne_zero y_ne_one h1
...
lemma Y'_observation1
  ...
  X ≠ 1 → χ_of_Y = χ_of_v * χ_of_u'_pow_two_add_one_over_c_pow_two  := by
    ...
    let χ_of_v'_eq_z'_unfold_of_X'_ne_1 := χ_of_v'_eq_z'_unfold_of_X'_ne_1 s_h1 s_h2 field_cardinality q_prime_power q_mod_4_congruent_3 point point_props x_ne_zero y_ne_one h1
    let χ_of_v'_eq_χ_Y'_mul_u'_pow_two_add_one_over_c_pow_two := χ_of_v'_eq_χ_Y'_mul_u'_pow_two_add_one_over_c_pow_two s_h1 s_h2 field_cardinality q_prime_power q_mod_4_congruent_3 point point_props x_ne_zero y_ne_one
    unfold χ_of_v
    let term1 := (u^2 + 1 / c^2)
    let term2 := Y * term1
    ...
    have h4 : χ_of_term1 * χ_of_u'_pow_two_add_one_over_c_pow_two = 1 := by
      rw [← pow_two]
      let term1_ne_zero := u'_pow_two_add_one_over_c_pow_two_ne_zero s_h1 s_h2 field_cardinality q_prime_power q_mod_4_congruent_3 point
...
lemma Y'_observation2
  ...
  X ≠ 1 → Y = (χ_of_v * v)^((q + 1) / 4) * χ_of_v * χ_of_u'_pow_two_add_one_over_c_pow_two  := by
    ...
    let χ_of_Y := LegendreSymbol.χ Y
    let χ_of_v'_eq_z'_unfold_of_X'_ne_1 := χ_of_v'_eq_z'_unfold_of_X'_ne_1 s_h1 s_h2 field_cardinality q_prime_power q_mod_4_congruent_3 point point_props x_ne_zero y_ne_one h1
    let χ_of_v'_eq_χ_Y'_mul_u'_pow_two_add_one_over_c_pow_two := χ_of_v'_eq_χ_Y'_mul_u'_pow_two_add_one_over_c_pow_two s_h1 s_h2 field_cardinality q_prime_power q_mod_4_congruent_3 point point_props x_ne_zero y_ne_one h1
    let Y'_observation1 := Y'_observation1 s_h1 s_h2 field_cardinality q_prime_power q_mod_4_congruent_3 point point_props x_ne_zero y_ne_one h1
    change χ_of_Y = χ_of_v * χ_of_u'_pow_two_add_one_over_c_pow_two at Y'_observation1
    let Y'_pow_two_eq_χ_of_v'_mul_v' := Y'_pow_two_eq_χ_of_v'_mul_v' s_h1 s_h2 field_cardinality q_prime_power q_mod_4_congruent_3 point point_props x_ne_zero y_ne_one h1
    ...
    rw [← LegendreSymbol.χ_of_a_mul_b_eq_χ_of_a_mul_χ_of_b, ← pow_two]
    let Y'_ne_zero := Y'_ne_zero s_h1 s_h2 field_cardinality q_prime_power q_mod_4_congruent_3 point point_props x_ne_zero y_ne_one
    rw [LegendreSymbol.χ_of_a_pow_two_eq_one Y'_ne_zero field_cardinality q_mod_4_congruent_3]
    grind
